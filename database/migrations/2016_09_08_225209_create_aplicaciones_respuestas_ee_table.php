...
class CreateAplicacionesRespuestasEETable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aplicaciones_respuestas_ee', function (Blueprint $table) {
            $table->increments('id');
        ...
        Schema::table('aplicaciones_respuestas_ee', function (Blueprint $table) {
    ...
    {
        Schema::drop('aplicaciones_respuestas_ee');
    }
}
